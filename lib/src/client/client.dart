...
abstract class Client extends ClientBase {
  core.String basePath = "/prediction/v1.3/";
  ...
  HostedmodelsResource_ get hostedmodels => new HostedmodelsResource_(this);
  TrainingResource_ get training => new TrainingResource_(this);
